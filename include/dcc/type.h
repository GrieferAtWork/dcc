...
#define DCCTYPE_WCHAR       DCCTYPE_IBN(DCC_TARGET_SIZEOF_WCHAR_T)
#define DCCTYPE_CHAR16      DCCTYPE_IBN(DCC_TARGET_SIZEOF_CHAR16_T)
#define DCCTYPE_CHAR32      DCCTYPE_IBN(DCC_TARGET_SIZEOF_CHAR32_T)
#define DCCTYPE_WINT        DCCTYPE_IBN(DCC_TARGET_SIZEOF_WINT_T)
#define DCCTYPE_SIG_ATOMIC  DCCTYPE_IBN(DCC_TARGET_SIZEOF_SIG_ATOMIC_T)
#define DCCTYPE_INT_LEAST8  DCCTYPE_IBN(DCC_TARGET_SIZEOF_INT_LEAST8_T)
#define DCCTYPE_INT_LEAST16 DCCTYPE_IBN(DCC_TARGET_SIZEOF_INT_LEAST16_T)
#define DCCTYPE_INT_LEAST32 DCCTYPE_IBN(DCC_TARGET_SIZEOF_INT_LEAST32_T)
#define DCCTYPE_INT_LEAST64 DCCTYPE_IBN(DCC_TARGET_SIZEOF_INT_LEAST64_T)
#define DCCTYPE_INT_FAST8   DCCTYPE_IBN(DCC_TARGET_SIZEOF_INT_FAST8_T)
#define DCCTYPE_INT_FAST16  DCCTYPE_IBN(DCC_TARGET_SIZEOF_INT_FAST16_T)
#define DCCTYPE_INT_FAST32  DCCTYPE_IBN(DCC_TARGET_SIZEOF_INT_FAST32_T)
#define DCCTYPE_INT_FAST64  DCCTYPE_IBN(DCC_TARGET_SIZEOF_INT_FAST64_T)
#define DCCTYPE_INTMAX      DCCTYPE_IBN(DCC_TARGET_SIZEOF_INTMAX_T)

#define DCC_ISUNSIGNED_CHAR   (TPPLexer_Current->l_flags&TPPLEXER_FLAG_CHAR_UNSIGNED)
#define DCC_ISUNSIGNED_WCHAR   DCC_LX_HAS(DCC(EXT_WCHAR_UNSIGNED))
#define DCC_ISUNSIGNED_CHAR16  DCC_LX_HAS(DCC(EXT_CHAR16_UNSIGNED))
#define DCC_ISUNSIGNED_CHAR32  DCC_LX_HAS(DCC(EXT_CHAR32_UNSIGNED))

/* Effective user types. */
#define DCCTYPE_USERCHAR      (DCC_ISUNSIGNED_CHAR ? DCCTYPE_CHAR|DCCTYPE_UNSIGNED : DCCTYPE_CHAR)
#define DCCTYPE_USERWCHAR     (DCC_ISUNSIGNED_WCHAR ? DCCTYPE_WCHAR|DCCTYPE_UNSIGNED : DCCTYPE_WCHAR)
#define DCCTYPE_USERCHAR16    (DCC_ISUNSIGNED_CHAR16 ? DCCTYPE_CHAR16|DCCTYPE_UNSIGNED : DCCTYPE_CHAR16)
#define DCCTYPE_USERCHAR32    (DCC_ISUNSIGNED_CHAR32 ? DCCTYPE_CHAR32|DCCTYPE_UNSIGNED : DCCTYPE_CHAR32)
