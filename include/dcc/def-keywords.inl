...
#define SET_TEXT_IFELSE(c,tt,ff) \
{\
 static TPPSTRING_DEF(tt_text,tt); \
 static TPPSTRING_DEF(ff_text,ff); \
 SET_TEXT((c) ? (struct TPPString *)&tt_text \
              : (struct TPPString *)&ff_text);\
}

PREDEFINED_MACRO_IF(__CHAR_UNSIGNED__,HAS(EXT_UTILITY_MACROS) && DCC_ISUNSIGNED_CHAR,"1")
PREDEFINED_RT_MACRO_IF(__CHAR_MIN__,HAS(EXT_UTILITY_MACROS),SET_TEXT_IFELSE(DCC_ISUNSIGNED_CHAR,DCC_TARGET_MIN_U(DCC_TARGET_SIZEOF_CHAR),DCC_TARGET_MIN_S(DCC_TARGET_SIZEOF_CHAR)))
PREDEFINED_RT_MACRO_IF(__CHAR_MAX__,HAS(EXT_UTILITY_MACROS),SET_TEXT_IFELSE(DCC_ISUNSIGNED_CHAR,DCC_TARGET_MAX_U(DCC_TARGET_SIZEOF_CHAR),DCC_TARGET_MAX_S(DCC_TARGET_SIZEOF_CHAR)))

PREDEFINED_MACRO_IF(__WCHAR_UNSIGNED__,HAS(EXT_UTILITY_MACROS) && DCC_ISUNSIGNED_WCHAR,"1")
PREDEFINED_RT_MACRO_IF(__WCHAR_TYPE__,HAS(EXT_UTILITY_MACROS),SET_TEXT_IFELSE(DCC_ISUNSIGNED_WCHAR,DCC_TARGET_TYPE_U(DCC_TARGET_SIZEOF_WCHAR_T),DCC_TARGET_TYPE_S(DCC_TARGET_SIZEOF_WCHAR_T)))
PREDEFINED_RT_MACRO_IF(__WCHAR_MIN__,HAS(EXT_UTILITY_MACROS),SET_TEXT_IFELSE(DCC_ISUNSIGNED_WCHAR,DCC_TARGET_MIN_U(DCC_TARGET_SIZEOF_WCHAR_T),DCC_TARGET_MIN_S(DCC_TARGET_SIZEOF_WCHAR_T)))
PREDEFINED_RT_MACRO_IF(__WCHAR_MAX__,HAS(EXT_UTILITY_MACROS),SET_TEXT_IFELSE(DCC_ISUNSIGNED_WCHAR,DCC_TARGET_MAX_U(DCC_TARGET_SIZEOF_WCHAR_T),DCC_TARGET_MAX_S(DCC_TARGET_SIZEOF_WCHAR_T)))

PREDEFINED_MACRO_IF(__CHAR16_UNSIGNED__,HAS(EXT_UTILITY_MACROS) && DCC_ISUNSIGNED_CHAR16,"1")
PREDEFINED_RT_MACRO_IF(__CHAR16_TYPE__,HAS(EXT_UTILITY_MACROS),SET_TEXT_IFELSE(DCC_ISUNSIGNED_CHAR16,DCC_TARGET_TYPE_U(DCC_TARGET_SIZEOF_CHAR16_T),DCC_TARGET_TYPE_S(DCC_TARGET_SIZEOF_CHAR16_T)))
PREDEFINED_RT_MACRO_IF(__CHAR16_MIN__,HAS(EXT_UTILITY_MACROS),SET_TEXT_IFELSE(DCC_ISUNSIGNED_CHAR16,DCC_TARGET_MIN_U(DCC_TARGET_SIZEOF_CHAR16_T),DCC_TARGET_MIN_S(DCC_TARGET_SIZEOF_CHAR16_T)))
PREDEFINED_RT_MACRO_IF(__CHAR16_MAX__,HAS(EXT_UTILITY_MACROS),SET_TEXT_IFELSE(DCC_ISUNSIGNED_CHAR16,DCC_TARGET_MAX_U(DCC_TARGET_SIZEOF_CHAR16_T),DCC_TARGET_MAX_S(DCC_TARGET_SIZEOF_CHAR16_T)))

PREDEFINED_MACRO_IF(__CHAR32_UNSIGNED__,HAS(EXT_UTILITY_MACROS) && DCC_ISUNSIGNED_CHAR32,"1")
PREDEFINED_RT_MACRO_IF(__CHAR32_TYPE__,HAS(EXT_UTILITY_MACROS),SET_TEXT_IFELSE(DCC_ISUNSIGNED_CHAR32,DCC_TARGET_TYPE_U(DCC_TARGET_SIZEOF_CHAR32_T),DCC_TARGET_TYPE_S(DCC_TARGET_SIZEOF_CHAR32_T)))
PREDEFINED_RT_MACRO_IF(__CHAR32_MIN__,HAS(EXT_UTILITY_MACROS),SET_TEXT_IFELSE(DCC_ISUNSIGNED_CHAR32,DCC_TARGET_MIN_U(DCC_TARGET_SIZEOF_CHAR32_T),DCC_TARGET_MIN_S(DCC_TARGET_SIZEOF_CHAR32_T)))
PREDEFINED_RT_MACRO_IF(__CHAR32_MAX__,HAS(EXT_UTILITY_MACROS),SET_TEXT_IFELSE(DCC_ISUNSIGNED_CHAR32,DCC_TARGET_MAX_U(DCC_TARGET_SIZEOF_CHAR32_T),DCC_TARGET_MAX_S(DCC_TARGET_SIZEOF_CHAR32_T)))
#undef SET_TEXT_IFELSE
