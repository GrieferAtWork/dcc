...
DEF_WARNING(W_LIB_ELF_DYNAMIC_SYMNAME_CORRUPT,(WG_LIBLOAD),WSTATE_WARN,{ size_t i = ARG(size_t); char *n = ARG(char *); size_t o = ARG(size_t); WARNF("PT_DYNAMIC header #%lu of ELF binary '%s' contains symbol entry #%lu with currupt name at %lu (exceeding maximum of %lu)",(unsigned long)i,n,(unsigned long)o,(unsigned long)ARG(size_t)); })
