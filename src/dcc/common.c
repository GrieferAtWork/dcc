...
#define CM_MAX_LEVEL 7
static uint32_t const cm_level_flags[CM_MAX_LEVEL][2] = {
 /* level #0 */{DCCCOMPILER_FLUSHFLAG_NONE,DCCUNIT_FLUSHFLAG_NONE},
 /* level #1 */{DCCCOMPILER_FLUSHFLAG_NONE,DCCUNIT_FLUSHFLAG_NONE},
 /* level #2 */{DCCCOMPILER_FLUSHFLAG_VSTACK,DCCUNIT_FLUSHFLAG_NONE},
 /* level #3 */{DCCCOMPILER_FLUSHFLAG_NONE,DCCUNIT_FLUSHFLAG_SECMEM},
 /* level #4 */{DCCCOMPILER_FLUSHFLAG_NONE,DCCUNIT_FLUSHFLAG_SECTRAIL},
 /* level #5 */{DCCCOMPILER_FLUSHFLAG_DECLTAB,DCCUNIT_FLUSHFLAG_SYMTAB},
 /* level #6 */{DCCCOMPILER_FLUSHFLAG_DECLTAB|DCCCOMPILER_FLUSHFLAG_TABMIN,
