...
#define A(a) (void)(buf = a2l_setarg(buf,a))
 ...
 } else if (new_state->s_addr < old_state->s_addr) {
...
#if USE_ABS_DEBUG
   op      += (A2L_O_SL_SC_IA-A2L_O_IL_SC_IA);
   line_off = new_state->s_line;
#else
   if (new_state->s_line > old_state->s_line) {
