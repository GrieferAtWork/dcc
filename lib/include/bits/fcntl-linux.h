...
#   define __FILE_FUN(x) __asm__(x "64")
#else
#   define __FILE_FUN(x)
#endif
...
__IMP __CRT_UNSUPPORTED_MSVC __CRT_UNSUPPORTED_KOS int (fallocate)(int __fd, int __mode, __off_t __offset, __off_t __len) __FILE_FUN("fallocate");
#ifdef __USE_LARGEFILE64
